...
*Scaling Gaussian Process Regression with Full Derivative Observations*. (Transactions on Machine Learning Research, 2026) [[paper]](https://openreview.net/pdf?id=fbonXp38r9) [[dsoftki]](https://github.com/base26labs/dsoftki_gp) **Daniel Huang**. 
